...
type AddUserReq struct {
	...
	DeletedAt     int64                  `protobuf:"varint,5,opt,name=deletedAt,proto3" json:"deletedAt,omitempty"` //deletedAt
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x9e, 0x01, 0x0a, 0x0a,
	...
	0x03, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x0d, 0x0a, 0x0b,
	0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x22, 0xb1, 0x01, 0x0a, 0x0d,
	...
	0x72, 0x22, 0xdb, 0x01, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72,
	...
	0x32, 0xa6, 0x02, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x2a, 0x0a, 0x07, 0x41, 0x64, 0x64,
...
var file_user_proto_goTypes = []any{
	...
	(*LoginReq)(nil),        // 11: pb.LoginReq
	(*LoginResp)(nil),       // 12: pb.LoginResp
}
var file_user_proto_depIdxs = []int32{
	...
	11, // 7: pb.user.Login:input_type -> pb.LoginReq
	2,  // 8: pb.user.AddUser:output_type -> pb.AddUserResp
	4,  // 9: pb.user.UpdateUser:output_type -> pb.UpdateUserResp
	6,  // 10: pb.user.DelUser:output_type -> pb.DelUserResp
	8,  // 11: pb.user.GetUserById:output_type -> pb.GetUserByIdResp
	10, // 12: pb.user.SearchUser:output_type -> pb.SearchUserResp
	12, // 13: pb.user.Login:output_type -> pb.LoginResp
